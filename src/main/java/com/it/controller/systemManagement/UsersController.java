...
public class UsersController extends BaseController{
	...
	@RequiresPermissions("userInfo:view")
	public Result selectList(UserInfo po, HttpServletRequest request){
	...
	@RequiresPermissions(value = "userinfo:accredit")
	@OperLogs(value = "用户授权")
	...
	@RequiresPermissions(value="roleinfo:updatePass")
	@OperLogs(value = "修改密码")
	...
	@RequiresPermissions(value="userinfo:exportExcel")
