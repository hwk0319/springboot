...
(function ($) {
    ...
    var init_tree_container = function () {
        ...
        this.tree_container = $('<div class="menuContent" id="menuContent" style="display:none;background-color: white; position: absolute;z-index:110004;border: solid 1px #ccc;border-radius: 5px;padding-bottom: 10px;width:100%;" >' +
